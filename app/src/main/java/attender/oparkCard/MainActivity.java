...
import attender.oparkCard.booking.AvailableSlotModel;
import attender.oparkCard.booking.CheckOutModel;
import attender.oparkCard.booking.FourWheeler;
import attender.oparkCard.booking.PatientVehicleWheeler;
import attender.oparkCard.booking.QRScanPrint;
import attender.oparkCard.booking.ReprintActivity;
import attender.oparkCard.booking.ThreeWheeler;
import attender.oparkCard.booking.TwoWheeler;
import attender.oparkCard.login.Login;
import attender.oparkCard.booking.CheckInModel;
import attender.oparkCard.apkservices.MyService;
import attender.oparkCard.parkinglist.model.GateList;
import attender.oparkCard.shiftreport.ShiftReportctivity;
import attender.oparkCard.subscription.activity.RemoveCardActivity;
import attender.oparkCard.subscription.activity.RenewCard;
import attender.oparkCard.subscription.activity.Subscription;
import attender.oparkCard.subscription.model.CustomRequest;
import attender.oparkCard.subscription.model.SubscriptionModel;
import attender.oparkCard.subscription.activity.Subscriptionctivity;
import attender.oparkCard.subscription.model.SubscriptionModelNew;
import attender.oparkCard.vehiclelist.activity.FourWheelerList;
import attender.oparkCard.vehiclelist.activity.LossReceipt;
import attender.oparkCard.vehiclelist.activity.PatientVehicleWheelerList;
import attender.oparkCard.vehiclelist.activity.ThreeWheelerList;
import attender.oparkCard.vehiclelist.activity.TwoWheelerList;
...
//                pDialog.dismiss();
    ...
    public void vehicleCheckOutt(String getParkingID, String agentId, String vehicleNo, String userType, String gateId, String tagID) {
        ...
        String urlData = AppConstants.BASEURL + "parking/checkout?parkingId=" + getParkingID + "&vehicleNo=" + vehicleNo + "&agentId="
                + agentId + "&userdata=" + userType + "&cardNo=" + tagID + "&gateId=" + GateId;
    ...
    class DownloadNewVersion extends AsyncTask<String, Integer, Boolean> {
        ...
        protected Boolean doInBackground(String... arg0) {
            ...
            try {
                ...
                URL url = new URL("https://opark.in/O_par_aPi/jhhospital/apk/app-debug.apk"); //Live
