package attender.oparkCard.subscription.activity;
...
import attender.oparkCard.subscription.model.InputValidation;
                        ...
                        try {
                            ...
                            if (status == 0) {
                                ...
                                for (int i = 0; i < arrayObj.length(); i++) {
                                    ...
                                    if (!duratioList.contains("1 Months")) {
                                        /*durationLits.clear();
                               ...
                               /* spinnerDurationn.setAdapter(new ArrayAdapter(RenewCard.this,
                                ...
                                spinnerDurationn.setAdapter(new ArrayAdapter(RenewCard.this, R.layout.my_spinner_style, duratioList));
                                pDialog.dismiss();
                            }
